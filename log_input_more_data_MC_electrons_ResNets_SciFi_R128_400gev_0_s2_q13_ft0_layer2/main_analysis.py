...
if __name__ == "__main__":
    ...
    output_prefix = "log_input_more_data_MC_electrons_ResNets_SciFi_R128_400gev_0_s2_q13_ft0_layer2"
    
    model_checkpoint_path = "/eos/experiment/sndlhc/users/beturk/DL_Electron_Reconstruction_Models/Energy_Recon/log_input_more_data_MC_electrons_ResNets_SciFi_R128_400gev_0_s2_q13_ft0_layer2" # Update to actual path
